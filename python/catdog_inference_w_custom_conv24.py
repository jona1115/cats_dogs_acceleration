...
# Compile c code and run: g++ -fPIC -shared -o lib_run_conv2d_24.so run_conv2d_24.cpp && python catdog_inference_w_custom_conv24.py
...
# Example usage
image_path = './build/dataset/test/cat.1035.jpg'
...
# Example usage in your Python workflow
...
print("^^^ With Custom C++ Layer")
print("vvv Without Custom C++ Layer")

#####################################################################################
#####################################################################################
# No custom:
def load_and_prepare_image2(image_path, target_size=(250, 200)):
...
def run_inference(image_path):
    # img_array = load_and_prepare_image2(image_path)
